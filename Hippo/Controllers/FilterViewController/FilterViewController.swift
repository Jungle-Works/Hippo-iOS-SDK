...
class FilterViewController: UIViewController {
    ...
    private func setupController() {
        ...
        optionsTableView.backgroundColor = theme.systemBackgroundColor.primary
        resultTableview.backgroundColor = theme.systemBackgroundColor.secondary
        applyButtonHeightConstraint.constant = 0
        
        resetButton.setTitleColor(HippoTheme.current.themeColor, for: .normal)
        resetButton.backgroundColor = UIColor.veryLightBlue
        
        applyButton.clipsToBounds = true
        
        let group = HippoTheme.current.primaryButtonGroup
...
//        applyButton.setTitleColor(HippoTheme.current.headerTextColor, for: .normal)
    ...
    func setTheme() {
        ...
        view.backgroundColor = theme.systemBackgroundColor.primary
    }
...
extension FilterViewController: UITableViewDataSource {
    ...
    fileprivate func setupTableView() {
        ...
        optionsTableView.register(UINib(nibName: "FilterOptionTableViewCell", bundle: nil), forCellReuseIdentifier: "FilterOptionTableViewCell")
        
        resultTableview.register(UINib(nibName: "StartEndDateCell", bundle: nil), forCellReuseIdentifier: "StartEndDateCell")
        resultTableview.register(UINib(nibName: "DateFilterTableViewCell", bundle: nil), forCellReuseIdentifier: "DateFilterTableViewCell")
        resultTableview.register(UINib(nibName: "NoCustomersFoundTableViewCell", bundle: nil), forCellReuseIdentifier: "NoCustomersFoundTableViewCell")
        resultTableview.register(UINib(nibName: "FilterTableViewCell", bundle: nil), forCellReuseIdentifier: "FilterTableViewCell")
        resultTableview.register(UINib(nibName: "ChatInfoShowMoreTableViewCell", bundle: nil), forCellReuseIdentifier: "ChatInfoShowMoreTableViewCell")
        resultTableview.register(UINib(nibName: "SearchCustomerTableViewCell", bundle: nil), forCellReuseIdentifier: "SearchCustomerTableViewCell")
        resultTableview.register(UINib(nibName: "NoCustomersFoundTableViewCell", bundle: nil), forCellReuseIdentifier: "NoCustomersFoundTableViewCell")
        resultTableview.register(UINib(nibName: "RecentSearchedCustomerTableViewCell", bundle: nil), forCellReuseIdentifier: "RecentSearchedCustomerTableViewCell")
        resultTableview.register(UINib(nibName: "FilterChannelCell", bundle: nil), forCellReuseIdentifier: "FilterChannelCell")
    }
