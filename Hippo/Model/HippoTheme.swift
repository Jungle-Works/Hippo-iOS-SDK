...
@objc public class HippoTheme: NSObject {
    ...
    open var themeColor: UIColor = UIColor(red: 95/255, green: 14/255, blue: 109/255, alpha: 1)
    
    var gradientTopColor = UIColor(red: 95/255, green: 14/255, blue: 109/255, alpha: 1)//UIColor(red: 77/255, green: 124/255, blue: 254/255, alpha: 1)
