...
struct FuguNewChatAttributes {
   ...
   init(transactionId: String, userUniqueKey: String? = nil, otherUniqueKey: [String]? = nil, tags: [String]? = nil, channelName: String? = nil, preMessage: String = "") {
   ...
   func getParamsToStartNewChat() -> [String: Any] {
     ...
     if isInAppChat {
        params["in_app_support_channel"] = 1
     }
    if isCustomAttributesRequired {
